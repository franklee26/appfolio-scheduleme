...
Job.create(id:2, content:"zoom2",Tenant_id: t_one.id, Vendor_id: v_two.id, title: 'job2', job_type: 'plumbing', status: 'pending')
Job.create(id:3, content:"zoom3",Tenant_id: t_two.id, Vendor_id: v_one.id, title: 'job3', job_type: 'cleaning', status: 'pending')
Job.create(id:4, content:"zoom4",Tenant_id: t_one.id, Vendor_id: v_one.id, title: 'job4', job_type: 'electrician', status: 'pending')
Job.create(id:5, content:"zoom5",Tenant_id: t_one.id, Vendor_id: v_two.id, title: 'job5', job_type: 'plumbing', status: 'pending')
Job.create(id:6, content:"zoom6",Tenant_id: t_one.id, Vendor_id: v_one.id, title: 'job6', job_type: 'cleaning', status: 'pending')
Job.create(id:7, content:"zoom7",Tenant_id: t_one.id, Vendor_id: v_two.id, title: 'job7', job_type: 'electrician', status: 'pending')
Job.create(id:8, content:"zoom8",Tenant_id: t_one.id, Vendor_id: v_one.id, title: 'job8', job_type: 'plumbing', status: 'pending')
Job.create(id:9, content:"zoom9",Tenant_id: t_one.id, Vendor_id: v_two.id, title: 'job9', job_type: 'electrician', status: 'pending')
Job.create(id:10, content:"zoom10",Tenant_id: t_one.id, Vendor_id: v_one.id, title: 'job10', job_type: 'cleaning', status: 'pending')
Job.create(id:11, content:"zoom11",Tenant_id: t_one.id, Vendor_id: v_two.id, title: 'job11', job_type: 'plumbing', status: 'pending')
Job.create(id:12, content:"zoom12",Tenant_id: t_one.id, Vendor_id: v_one.id, title: 'job12', job_type: 'electrician', status: 'pending')
Job.create(id:13, content:"zoom13",Tenant_id: t_one.id, Vendor_id: v_two.id, title: 'job13', job_type: 'cleaning', status: 'completed')
