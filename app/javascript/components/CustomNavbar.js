...
class CustomNavbar extends React.Component {
  constructor(props) {
    ...
    this.state = {
      logged_in: false,
      profile_pic: "https://scheduleme.s3-us-west-1.amazonaws.com/missing_300x300.png"
    }
  }
      ...
      <Navbar bg="light" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            id="dropdown">
              <NavDropdown.Item href="/sessions/profile">Profile</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="/sessions/logout">Logout</NavDropdown.Item>
            </NavDropdown>}
        </Navbar.Collapse>
      </Navbar>
    );
